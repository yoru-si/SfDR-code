...
bool relbot_msgs__msg__relbot_motors_stamped__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("relbot_msgs.msg._relbot_motors_stamped.RelbotMotorsStamped", full_classname_dest, 58) == 0);
  }
  relbot_msgs__msg__RelbotMotorsStamped * ros_message = _ros_message;
  {  // header
  ...
  {  // motor_cmd
    ...
    if (!relbot_msgs__msg__relbot_motors__convert_from_py(field, &ros_message->motor_cmd)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of RelbotMotorsStamped */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("relbot_msgs.msg._relbot_motors_stamped");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RelbotMotorsStamped");
  ...
  {  // motor_cmd
    PyObject * field = NULL;
    field = relbot_msgs__msg__relbot_motors__convert_to_py(&ros_message->motor_cmd);
    if (!field) {
      return NULL;
    }
    {
