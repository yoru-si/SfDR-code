...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Ros2Xeno_message_member_array[4] = {
  {
    "pos_left",  // name
    ...
    offsetof(xrf2_msgs::msg::Ros2Xeno, pos_left),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(xrf2_msgs::msg::Ros2Xeno, pos_right),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(xrf2_msgs::msg::Ros2Xeno, set_pos_left),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(xrf2_msgs::msg::Ros2Xeno, set_pos_right),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
