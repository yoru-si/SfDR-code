...
sdfr_ppd::sdfr_ppd(uint write_decimator_freq, uint monitor_freq) :
    ...
    file(1,"./xrf2_logging/sdfr_ppd","bin"), // change template to your project name
    controller()
{
